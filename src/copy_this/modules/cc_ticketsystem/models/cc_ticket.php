...
class cc_ticket extends oxBase {
	...
	*/
	...
	public function getTextList() {
		...
		$this->_sUserFullName = $sUserComp . $oUser->oxuser__oxfname->rawValue . ' ' . $oUser->oxuser__oxlname->rawValue . ', #' . $oUser->oxuser__oxcustnr->rawValue;
	...
	*/
	...
	protected function _prepareForTemplate($aTextList) {
		...
		foreach ($aTextList as $oText) {
			$aTexts[$oText->cctickettexts__oxid->rawValue]['ticketoxid'] = $oText->cctickettexts__oxid->rawValue;
